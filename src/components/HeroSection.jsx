...
export default function HeroSection() {
  return (
    <section className="relative flex flex-col items-center justify-center text-center py-24 md:py-32 transition-colors duration-300" style={{ backgroundColor: 'var(--color-bg)', color: 'var(--color-text)' }}>
      {}
      <motion.div
      ...
      >
        ...
        <p className="text-base sm:text-lg md:text-xl mt-4" style={{ color: 'var(--color-text-secondary)' }}>
      ...
      >
        <Input
          ...
          className="w-full rounded-lg transition-colors" style={{ backgroundColor: 'var(--color-bg-tertiary)', color: 'var(--color-text)', borderColor: 'var(--color-border)' }}
        />
      ...
      >
        <span className="text-sm mb-2" style={{ color: 'var(--color-text-muted)' }}>Trending:</span>
